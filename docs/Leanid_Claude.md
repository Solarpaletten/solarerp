1-2-3
➜  solar-erp git:(main) ✗ cat app/api/company/[companyId]/accounts/[accountId]/route.ts                           
...
➜  solar-erp git:(main) ✗ cat app/api/company/[companyId]/purchases/[purchaseId]/post/route.ts                                                         
...
➜  solar-erp git:(main) ✗ cat docs/PostedAccountingView.tsx                                                                
...
4-5-6 
➜  solar-erp git:(main) ✗ cat app/(dashboard)/company/[companyId]/purchases/[purchaseId]/page.tsx                             
...
➜  solar-erp git:(main) ✗ cat app/api/company/[companyId]/purchases/[purchaseId]/receipt/route.ts
