...
-- CreateEnum
CREATE TYPE "ClientRole" AS ENUM ('CUSTOMER', 'SUPPLIER', 'BOTH');
...
-- CreateIndex
CREATE INDEX "sale_documents_clientId_idx" ON "sale_documents"("clientId");
...
-- CreateIndex
CREATE INDEX "purchase_documents_supplierId_idx" ON "purchase_documents"("supplierId");
