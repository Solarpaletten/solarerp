...
// ═══════════════════════════════════════════════════
// Task 37A: Purchase Document Page (Read View)
// ═══════════════════════════════════════════════════
// Structure:
//   ├── Back link
//   ├── PurchaseHeader       (37A ✅)
//   ├── PurchaseItemsTable   (37B — placeholder)
...
export default function PurchaseDocumentPage() {
  ...
  return (
    <div className="p-6 space-y-4">
      ...
      {/* Items Table — Task 37B placeholder */}
      <div className="bg-white border border-gray-200 rounded-lg px-5 py-8 text-center">
        <p className="text-xs text-gray-400">📋 Items table — Task 37B</p>
      </div>
