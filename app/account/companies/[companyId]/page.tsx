...
// This is the main company workspace page
...
export default function CompanyDashboard() {
  ...
  const modules = [
    { name: 'Clients',    icon: '👥', href: `${base}/clients`,    color: 'from-blue-500 to-blue-600',    count: '—' },
    { name: 'Products',   icon: '📦', href: `${base}/products`,   color: 'from-green-500 to-green-600',  count: '—' },
    { name: 'Sales',      icon: '💰', href: `${base}/sales`,      color: 'from-purple-500 to-purple-600', count: '—' },
    { name: 'Purchases',  icon: '🛒', href: `${base}/purchases`,  color: 'from-red-500 to-red-600',      count: '—' },
    { name: 'Warehouse',  icon: '🏭', href: `${base}/warehouse`,  color: 'from-yellow-500 to-yellow-600', count: '—' },
    { name: 'Bank',       icon: '🏦', href: `${base}/bank`,       color: 'from-orange-500 to-orange-600', count: '—' },
  ];
